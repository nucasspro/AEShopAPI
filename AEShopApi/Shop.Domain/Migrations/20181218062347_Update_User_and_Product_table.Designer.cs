...
namespace Shop.Domain.Migrations
{
    ...
    [Migration("20181218062347_Update_User_and_Product_table")]
    partial class Update_User_and_Product_table
    {
            ...
            modelBuilder.Entity("Shop.Domain.Entities.ProductStatusType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, InsertedAt = 1545114225, Name = "Out of stock", UpdatedAt = 1545114225 },
                        new { Id = 2, InsertedAt = 1545114225, Name = "Stock", UpdatedAt = 1545114225 },
                        new { Id = 3, InsertedAt = 1545114225, Name = "Removed", UpdatedAt = 1545114225 }
                    );
                });
            ...
            modelBuilder.Entity("Shop.Domain.Entities.UserStatusType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, InsertedAt = 1545114225, Name = "Deactivated", UpdatedAt = 1545114225 },
                        new { Id = 2, InsertedAt = 1545114225, Name = "Activated", UpdatedAt = 1545114225 },
                        new { Id = 3, InsertedAt = 1545114225, Name = "Removed", UpdatedAt = 1545114225 }
                    );
                });
