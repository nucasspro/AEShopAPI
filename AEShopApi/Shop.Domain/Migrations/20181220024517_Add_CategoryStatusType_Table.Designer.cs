...
namespace Shop.Domain.Migrations
{
    ...
    [Migration("20181220024517_Add_CategoryStatusType_Table")]
    partial class Add_CategoryStatusType_Table
    {
            ...
            modelBuilder.Entity("Shop.Domain.Entities.CategoryStatusType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, InsertedAt = 1545273916, Name = "Actived", UpdatedAt = 1545273916 },
                        new { Id = 2, InsertedAt = 1545273916, Name = "Removed", UpdatedAt = 1545273916 }
                    );
                });
            ...
            modelBuilder.Entity("Shop.Domain.Entities.ProductStatusType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, InsertedAt = 1545273916, Name = "Out of stock", UpdatedAt = 1545273916 },
                        new { Id = 2, InsertedAt = 1545273916, Name = "Stock", UpdatedAt = 1545273916 },
                        new { Id = 3, InsertedAt = 1545273916, Name = "Removed", UpdatedAt = 1545273916 }
                    );
                });
            ...
            modelBuilder.Entity("Shop.Domain.Entities.UserStatusType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, InsertedAt = 1545273916, Name = "Deactivated", UpdatedAt = 1545273916 },
                        new { Id = 2, InsertedAt = 1545273916, Name = "Activated", UpdatedAt = 1545273916 },
                        new { Id = 3, InsertedAt = 1545273916, Name = "Removed", UpdatedAt = 1545273916 }
                    );
                });
